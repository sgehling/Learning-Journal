...
2. `git commit-m 'details'` allows you to describe why/what you made the changes
3. `git push origin master` allows you to send your changes to you **Github** repository.
